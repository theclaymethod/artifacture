...
**The route catalog and semantic patterns live in `./diagram-design.md`; shared SVG geometry, complexity budgets, removal test, and anti-patterns live in `./diagrams-svg.md`.** This section summarizes the rendering-approach decision per type. Aesthetic token mappings live in `./diagram-tokens.md`.
